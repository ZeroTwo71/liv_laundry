...
{
	// Fungsi untuk menghasilkan kode resi acak
	private function generateResi()
	{
		return strtoupper(bin2hex(random_bytes(4))); // Generates an 8 character random string
	}
	...
	public function new_laundry($customer, $priority, $weight, $type)
	{
		...
		$status = 'diproses'; // Status awal ketika pesanan baru dibuat
